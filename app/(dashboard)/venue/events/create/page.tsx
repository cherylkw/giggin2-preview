...
export default function VenueCreateEventPage() {
  ...
  const [ticketTiers, setTicketTiers] = useState<TicketTier[]>([
    { id: "1", name: "General Admission", description: "Standard entry", price: 45, quantity: 500 },
  ])
          ...
          <div className="space-y-6">
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="e.g., The Blue Note Quartet"
              />
              <p className="text-xs text-muted-foreground">
                Enter the headlining artist or "Various Artists" for multi-act events
              </p>
            </div>
            ...
            <div className="rounded-lg border border-border p-6">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div>
                  ...
                  <p className="font-medium">{selectedGenres.join(", ") || "Not set"}</p>
                </div>
                <div>
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Host a new event at your venue</p>
        </div>
      </div>
